...
// Click favorite → favorites AND navigates ❌

// With stopPropagation():
// Click favorite → only favorites ✅
```
...
- ListingCard → Display listing info
...
- ✅ **Extracted component** - Separated concerns from ListingCard
