---
title: "L14: Add to ListingCard"
description: "Integrate the favorite button into ListingCard and ListingDetailsCard"
---


Let's add the favorite button to our listing cards so users can favorite listings!

## Current ListingCard Structure

Our `ListingCard` component displays listing information:
