...
│  /favorites   → ListingFavoritesPage     │
...
2. **Wrong path:**
   ```jsx
   // Wrong file path
   import ListingFavoritesPage from '@/pages/FavoritesPage';
   ```

3. **Component not exported:**
   ```jsx
   // In ListingFavoritesPage.jsx
   export default ListingFavoritesPage;  // Must be default export
   ```
