...
# Module 6 Review: State Management
...
<Tabs items={['HomePage', 'FavoritesPage', 'Navbar', 'FavoriteButton', 'ListingCard']}>
...
```jsx title="src/pages/ListingFavoritesPage.jsx"
import { useSelector } from 'react-redux';
...
// - Navbar (show count)
// - ListingCard (show favorite status)
...
2. Click heart icon on ListingCard
