...
<div className="space-y-4">
  <div>
    <p className="font-semibold">Required Features:</p>
    <div className="space-y-2">
      <label className="flex items-center gap-2">
        <Checkbox id="required-save" />
        <span>Save for later functionality works</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="required-heart" />
        <span>Heart icons toggle correctly</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="required-price" />
        <span>Price range filter works</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="required-type" />
        <span>Property type filter works</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="required-sort" />
        <span>Sort options work</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="required-combo" />
        <span>All filters work together</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="required-empty" />
        <span>Empty states handled</span>
      </label>
    </div>
  </div>
  ...
  <div>
    ...
    <div className="space-y-2">
      <label className="flex items-center gap-2">
        <Checkbox id="bonus-saved-view" />
        <span>Saved listings view works</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="bonus-chips-display" />
        <span>Active filter chips display</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="bonus-chips-remove" />
        <span>Filter chips removable</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="bonus-saved-filters" />
        <span>Filters work in saved view</span>
      </label>
    </div>
  </div>
  ...
  <div>
    ...
    <div className="space-y-2">
      <label className="flex items-center gap-2">
        <Checkbox id="quality-errors" />
        <span>No console errors</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="quality-props" />
        <span>Proper prop naming</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="quality-state" />
        <span>State lifted correctly</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="quality-structure" />
        <span>Components are organized</span>
      </label>
      <label className="flex items-center gap-2">
        <Checkbox id="quality-readable" />
        <span>Code is readable</span>
      </label>
    </div>
  </div>
</div>
