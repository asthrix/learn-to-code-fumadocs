...
prerequisites: ["/docs/react/m2/7_event-handler-best-practices"]
learning_objectives:
...
<div className='mt-8 flex justify-between'>
   <a
      href='/docs/react/m2/7_event-handler-best-practices'
      className='text-sm font-medium text-muted-foreground hover:text-foreground'
   >
      ← Event Handler Best Practices
   </a>
   <a
      href='/docs/react/m2/9_controlled-vs-uncontrolled'
