...
# Lesson 2: Creating the ListingFilters Component

<Badge variant="blue">Components</Badge>
<Badge variant="green">State</Badge>
<Badge variant="purple">Event Handling</Badge>
