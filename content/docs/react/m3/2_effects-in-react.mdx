...
prerequisites: ["/docs/react/m3/1_introduction-effects"]
learning_objectives:
   - "Describe the render → commit → effect timeline"
...
<Accordions type='single' className='mt-4'>
   <Accordion title='Solution Walkthrough'>
      ...
      ## Effect Timing
      - Initial Task Fetch → passive effect (`useEffect`), abort on cleanup.
      - Persist Task Mutations → passive effect triggered from handlers, abort on route change.
      - Document Title Sync → passive effect after stats update; no cleanup needed.
      - Scroll Restoration (future) → layout effect to measure positions.
      ```
...
<div className='mt-8 flex justify-between'>
   <a
      href='/docs/react/m3/1_introduction-effects'
      className='text-sm font-medium text-muted-foreground hover:text-foreground'
   >
      ← Introduction to Effects
   </a>
   <a
      href='/docs/react/m3/3_use-effect-deep-dive'
