...
<Accordions type='single'>
   <Accordion id='pages' title='pages/ Folder' value='pages'>
      ...
      **Examples:** 
      1. `HomePage.jsx` - The main landing page
      2. `PropertyDetailsPage.jsx` - Individual property view
      3. `LoginPage.jsx` - User login page 

      **Rule:** One page = one route in your application
   </Accordion>
   ...
   <Accordion id='components' title='components/ Folder' value='components'>
      ...
      **Examples:**
      1.  `PropertyCard.jsx` - Single property display card
      2. `Navbar.jsx` - Navigation bar
      3. `SearchBar.jsx` - Search input component 
      
      **Rule:** Should be reusable and not page-specific
   </Accordion>
</Accordions>
