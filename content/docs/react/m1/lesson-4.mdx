---
title: "Lesson 4: PropertyCard Component with Props"
description:
...
# Lesson 4: PropertyCard Component with Props
...
App
 └─ HomePage
     └─ PropertyCard (displays first property)
```
...
<div className='mt-6 flex gap-4'>
   <Button variant='outline' asChild>
      <a href='/docs/react/m1/lesson-3'>← Previous: Adding Property Data</a>
   </Button>
   <Button asChild>
      <a href='/docs/react/m1/lesson-5'>Next: PropertyList with Map →</a>
   </Button>
</div>
