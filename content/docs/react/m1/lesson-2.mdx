---
title: "Lesson 2: Creating the HomePage Component"
description: "Build your first custom React component from scratch."
module: 1
lesson: 2
---

# Lesson 2: Creating the HomePage Component
...
<div className='mt-6 flex gap-4'>
   <Button variant='outline' asChild>
      <a href='/docs/react/m1/lesson-1'>← Previous: Project Setup</a>
   </Button>
   <Button asChild>
      <a href='/docs/react/m1/lesson-3'>Next: Adding Property Data →</a>
   </Button>
</div>
