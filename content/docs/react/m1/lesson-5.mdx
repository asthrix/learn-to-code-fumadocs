...
<Steps>
   <Step> 
   #### properties.map() Loop through each property in the array
   </Step>
   <Step>
...
<Accordions type='single'>
   ...
   <Accordion id='key-warning' title='What Happens Without Keys?' value='key-warning'>
      ...
      <Callout type="warning" title="Warning: Key Missing">
...
<Files>
   <Folder name='App' defaultOpen>
      ...
      <Folder name='PropertyList' defaultOpen>
         <File name='PropertyCard (Beach House)' />
         <File name='PropertyCard  (Downtown Loft)' />
         <File name='PropertyCard  (Mountain Cabin)' />
         <File name='PropertyCard  (Lakefront Villa)' />
      </Folder>
      </Folder>
   </Folder>
</Files>
