...
prerequisites: ["/docs/react/m4/7_routing-best-practices"]
learning_objectives:
...
This is the hands-on glue work—TaskFlow Pro becomes a multi-page SPA with
...
<div className='mt-8 flex justify-between'>
   <a
      href='/docs/react/m4/7_routing-best-practices'
      className='text-sm font-medium text-muted-foreground hover:text-foreground'
   >
      ← Routing Best Practices
   </a>
   <a
      href='/docs/react/m4/9_validation'
