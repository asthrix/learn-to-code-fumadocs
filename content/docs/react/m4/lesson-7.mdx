  ...
  <div className="container mx-auto px-4 py-8">
    ...
    <div className="mb-6">
      ...
      <div className="flex items-center gap-4 text-sm text-gray-600">
        <span>📍 Malibu, California</span> {/* [!code --] */}
        <span>⭐ 4.8</span> {/* [!code --] */}
        <span>👥 124 reviews</span> {/* [!code --] */}
        <span>📍 {listing.location}</span> {/* [!code ++] */}
        <span>⭐ {listing.rating}</span> {/* [!code ++] */}
        <span>👥 {listing.reviews} reviews</span> {/* [!code ++] */}
      </div>
    </div>
        ...
        <div className="border border-gray-200 rounded-lg p-6 shadow-md sticky top-4">
          ...
          <div className="mb-4">
            <div className="text-sm text-gray-600 mb-2">
              ⭐ 4.8 · 124 reviews {/* [!code --] */}
              ⭐ {listing.rating} · {listing.reviews} reviews {/* [!code ++] */}
            </div>
          </div>
...
- User visits `/listing/1` → Fetches listing 1
- User navigates to `/listing/2` → Fetches listing 2
- User navigates to `/listing/3` → Fetches listing 3
...
- User visits `/listing/1` → Fetches listing 1 ✅
- User navigates to `/listing/2` → Nothing happens ❌
...
- useEffect runs again → fetches data
- Setting state causes re-render
- **Infinite loop!**
