...
<Accordions type='single' className='mt-4'>
   <Accordion title='Solution Walkthrough'>
      <p>This sample brief demonstrates the structure and depth expected.</p>

      ```md filename="portfolio-pulse/docs/project-brief.md"
      # Portfolio Pulse · Project Brief

      ## Outcomes
      - 5 qualified discovery calls within 60 days of relaunch.
      - Newsletter subscription rate up 10% month-over-month.
      - Recruiting replies within 48 hours for senior product design roles.

      ## Personas
      1. **Hiring Manager** — Needs convincing social proof and measurable impact.
      2. **Product Founder** — Evaluates collaboration style and delivery speed.
      3. **Design Peer** — Looks for process depth and tool stack alignment.

      ## Narrative Flow
      1. Hero positioning → promise measurable change.
      2. Highlight cards → showcase three case studies with outcome metrics.
      3. Services section → clarify how engagements run.
      4. Testimonials → reinforce trust with named partners.
      5. Contact → clear invite to book a chemistry call.

      ## Risks & Questions
      - Confirm permission to reference FluxHealth metrics publicly.
      - Need updated testimonial from Linh Chen (pending 2025-11-01 follow-up).
      - Determine whether to expose newsletter subscription on homepage or modal.

      ## Next Checks
      - Align copy with Avery on tone and CTA language.
      - Validate metrics still accurate during Module 4 audit.
      ```
