...
Log remaining gaps in `notes/retro-log.md` so Module 1 CSS can style the skip
...
**Why:** Focus indicators help keyboard users stay oriented while navigating the
menu and skip link.
...
```
      ...
      <p>Reinforce expectations in `docs/accessibility.md`:</p>
...
```
      ...
      <p>
         Log remaining gaps in `notes/retro-log.md` so Module 1 CSS can style the
         skip link and mobile menu state effectively.
      </p>
