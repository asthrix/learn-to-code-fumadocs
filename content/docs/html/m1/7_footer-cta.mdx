...
<Accordions className="mt-6">
    <Accordion title="Solution Walkthrough">
         <p>
             Wire up the footer using this pattern, then note reuse strategy in your
             layout plan.
         </p>
         ...
         <footer class="site-footer" role="contentinfo">
            <section class="footer-cta" aria-labelledby="footer-cta-title">
               <h2 id="footer-cta-title">Ready to build the next win?</h2>
               <p>
                  Email <a href="mailto:hello@averystone.design">hello@averystone.design</a>
            ...
            <section class="footer-grid">
               ...
               <nav aria-label="Footer navigation">
                  ...
                  <ul>
                     ...
                     <li>
                        <a href="/writing/index.html">Insights</a>
                     </li>
                  </ul>
               </nav>
               <div>
            ...
            <section class="footer-meta" aria-label="Legal">
               <small>&copy; <time datetime="2025">2025</time> Avery Stone. All rights reserved.</small>
               <ul class="legal-links">
                  <li><a href="/legal/privacy.html">Privacy</a></li>
                  <li><a href="/legal/accessibility.html">Accessibility</a></li>
               </ul>
         ...
         ```
         <p>
             Update `docs/layout-plan.md` so the footer strategy is easy to reuse:
         </p>
         ```md filename="docs/layout-plan.md"
         ### Footer Notes
         - Convert footer into partial once multiple pages ship (Module 3).
         - Newsletter form posts to ConvertKit; add honeypot field during Module 4.
         - Legal links reference shared /legal/ pages created in Module 2.
         ```
         <p>
             Record upcoming policy copy tasks in `notes/retro-log.md` to avoid
             losing track before deployment.
         </p>
    </Accordion>
