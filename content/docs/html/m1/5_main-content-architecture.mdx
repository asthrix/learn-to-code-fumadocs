...
<Accordions className="mt-6">
    <Accordion title="Solution Walkthrough">
            ...
            <section id="highlights" aria-labelledby="highlights-heading">
               ...
               <div class="case-study-grid">
                  ...
                  <article class="case-card" aria-labelledby="case-aurora">
                     ...
                     <p>
                        Launched knowledge base experiments that improved self-serve success.
                     </p>
                  </article>
               </div>
            </section>
            ...
            <section id="services" aria-labelledby="services-title">
               ...
               <ol class="service-steps">
                  <li>
                     <h3>Discovery Sprint</h3>
                     <p>
                        Audit current journeys, define target metrics, and align stakeholders.
                     </p>
                  </li>
                  <li>
                     <h3>Design & Prototype</h3>
                     <p>
                        Translate insights into interactive prototypes and validation scripts.
                     </p>
                  </li>
                  <li>
                     <h3>Launch & Iterate</h3>
         ...
         ```md filename="notes/retro-log.md"
