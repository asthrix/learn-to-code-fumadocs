...
<Accordions className="mt-6">
    <Accordion title="Solution Walkthrough">
         <p>
             Implement a credentials aside similar to this example, then log missing
         ...
         <aside class="sidebar" aria-labelledby="sidebar-credentials">
            ...
            <section aria-labelledby="quick-stats">
               ...
               <dl class="stat-list">
                  <div>
                     <dt>Experience</dt>
                     <dd>
                        <time datetime="2015">10 years shipping products</time>
                     </dd>
                  </div>
                  <div>
                     <dt>Launched products</dt>
                     <dd>24 end-to-end engagements</dd>
                  </div>
                  <div>
                     <dt>Avg. uplift</dt>
                     <dd>
                        <strong>18%</strong> retention improvement
                     </dd>
                  </div>
               </dl>
            </section>
            ...
            <section aria-labelledby="availability-title">
               ...
               <p>
                  Accepting new collaborations starting <time datetime="2024-07">July 2024</time>.
               </p>
            </section>
         </aside>
         ```
         <p>
             Track outstanding assets in `notes/retro-log.md`:
         </p>
         ```md filename="notes/retro-log.md"
         ### Aside Follow-ups
         - Replace placeholder press URLs with real links once approved (Owner: Avery)
         - Confirm availability date with calendar (Owner: Avery)
         - Gather updated stat for average uplift from analytics (Owner: Jordan)
         ```
         <p>
             Update the layout plan to note that the aside should stack below the
             highlights section on narrow viewports.
         </p>
    </Accordion>
