...
<Accordions className="mt-6">
    <Accordion title="Solution Walkthrough">
         <p>
             Use this header markup as a starting point, then document responsive
         ...
         <header class="site-header" role="banner">
            <div class="brand">
               <a href="#top" aria-label="Portfolio Pulse">
                  <span aria-hidden="true" class="brand-mark">PP</span>
                  <span class="sr-only">Portfolio Pulse</span>
               </a>
            </div>
            ...
            <details class="nav-mobile">
               <summary aria-haspopup="listbox" aria-controls="mobile-nav-list">
                  Menu
               </summary>
               <nav aria-label="Mobile navigation">
         ...
         ```
         <p>
             Record responsive guidance in `docs/layout-plan.md` so future styling
             work has clear direction:
         </p>
         ```md filename="docs/layout-plan.md"
         ### Header Responsive Notes
         - Desktop: nav-desktop visible, nav-mobile hidden
         - Mobile: nav-desktop hidden, nav-mobile expands full width
         - Summary focus state: outline 3px accent, offset 4px
         - TODO: replace duplicate nav lists with partial include once templating added
         ```
    </Accordion>
