...
prerequisites: ["/docs/react-new/m5/7_custom-components-patterns"]
learning_objectives:
...
Controllers and hooks are now solid—next up is ensuring components use those
...
<div className='mt-8 flex justify-between'>
   ...
   <a
      href='/docs/react-new/m5/9_implementation'
