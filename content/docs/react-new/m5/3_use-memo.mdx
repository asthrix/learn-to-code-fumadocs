...
prerequisites: ["/docs/react-new/m5/2_performance-in-react"]
learning_objectives:
...
<Accordions type='single' className='mt-4'>
   <Accordion title='Solution Walkthrough'>
      ...
      ## Memoisation Results
      - `filterTasks` duration: 170ms → 58ms (React Profiler average)
      - `DashboardStats` renders: 6 → 2 per search keystroke
      ```
