   ...
   pricing: [
      {
         ...
         cadence: "forever",
         description:
            "Access to Module 0 and Module 1 to get started with React fundamentals.",
         features: [
            "Module 0: Introduction (5 lessons)",
            "Module 1: React Fundamentals (7 lessons)",
            "Community support",
         ],
      ...
      },
      {
         ...
         cadence: "one-time",
         description:
            "Complete access to all 9 modules with 90+ lessons covering React from basics to deployment.",
         features: [
            "All 9 modules (90+ lessons)",
      ...
      },
      {
         ...
         cadence: "per team",
         description:
            "Perfect for teams of 5-10 developers learning React together with shared progress tracking.",
         features: [
